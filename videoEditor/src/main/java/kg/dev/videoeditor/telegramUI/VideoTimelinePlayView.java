...
import static kg.dev.videoeditor.telegramUI.AndroidUtilities.clamp;
import static kg.dev.videoeditor.telegramUI.AndroidUtilities.dp;
import static kg.dev.videoeditor.telegramUI.AndroidUtilities.dpf2;
...
public class VideoTimelinePlayView extends View {
    ...
    private void reloadFrames(int frameNum) {
        ...
        if (frameNum == 0) {
            ...
            aspectRatio = clamp(aspectRatio, 4 / 3f, 9f / 16f);
